    ...
    <div class="grid-item-60-wrap fcenter">
        <div class="grid-item-content-wrap copy">
            ...
            <div class="b2">
                ...
                <p>
                    <strong>We want BuildGrid to be as open and transparent <br>
                        as the marketplace we've created.</strong> So let us know
                    <br> what's on your mind and we'll get back to you
                    <br> as soon as we can.
                </p>
            </div>
            <ul class="contact-social-wrap">
                <li><a href="" target="_blank"><i class="icon ion-social-facebook"></i></a></li>
